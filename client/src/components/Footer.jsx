        ...
        <footer className="bg-neutral-900 text-white mt-10">
          <div className="container mx-auto px-6 pt-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-20 text-left md:text-left align-items:center">
              ...
              <div>
                <h5 className="uppercase font-bold mb-2.5"> Alumni hub</h5>
                <p className="mb-4">
                 Alumni Network, an exclusive platform that connects the alumni of the department at Madan Mohan Malaviya University of Technology (MMMUT).
                </p>
              </div>
